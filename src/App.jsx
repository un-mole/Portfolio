...
function App() {
  ...
  const projectsRef = useRef(null); // Create a ref for Projects
    ...
    <div className="flex flex-col md:flex-row md:h-screen h-full w-screen overflow-x-hidden font-montserrat">
      ...
      >
        <div className="flex flex-col items-center md:mb-14 mb-8 mt-5 md:mt-0">
          <img
            src="dp.jpg"
            className="w-40 md:w-40 rounded-full mb-7"
            alt="Profile"
          />
          <div className="text-lg font-bold text-center">Anmol Raykhere</div>
        </div>
        <nav className="flex md:flex-col flex-row md:gap-7 gap-5 text-center">
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className="md:size-5 size-0 -translate-y-0.5"
            >
